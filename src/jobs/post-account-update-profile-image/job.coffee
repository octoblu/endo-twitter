...
class PostAccountUpdateProfileImage
  ...
  do: ({data}, callback) =>
    data ?= {}
    return callback @_userError(422, 'Image is required') unless data.image?

    @twitter.post 'account/update_profile_image', data, (error, data) =>
...
module.exports = PostAccountUpdateProfileImage
