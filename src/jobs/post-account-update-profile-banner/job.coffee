...
class PostAccountUpdateProfileBanner
  ...
  do: ({data}, callback) =>
    data ?= {}
    return callback @_userError(422, 'Banner is required') unless data.banner?

    @twitter.post 'account/update_profile_banner', data, (error, data) =>
...
module.exports = PostAccountUpdateProfileBanner
