...
class PostSavedSearchesCreate
  ...
  do: ({data}, callback) =>
    data ?= {}
    return callback @_userError(422, 'Query is required') unless data.query?

    @twitter.post 'saved_searches/create', data, (error, data) =>
...
module.exports = PostSavedSearchesCreate
