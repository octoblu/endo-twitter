...
class GetStatusesOembed
  ...
  do: ({data}, callback) =>
    data ?= {}
    return callback @_userError(422, 'Url is required') unless data.url?

    @twitter.get 'statuses/oembed', data, (error, data) =>
...
module.exports = GetStatusesOembed
