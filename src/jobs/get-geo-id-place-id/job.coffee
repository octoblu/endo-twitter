...
class GetGeoIdPlaceId
  ...
  do: ({data}, callback) =>
    data ?= {}
    return callback @_userError(422, 'Place ID is required') unless data.place_id?

    @twitter.get 'geo/id/' + data.place_id, data, (error, data) =>
...
module.exports = GetGeoIdPlaceId
